    ...
    <div className="assignment-detail">
      <div className="assignment-detail__header">
        ...
        <div className="assignment-detail__header-right">
          <div className="assignment-detail__score">Оценка: {score}</div>
          <button className="assignment-detail__submit-btn">Сдать</button>
        </div>
      </div>
      ...
      <div className="assignment-detail__body">
        <div className="assignment-detail__info">
          <div className="assignment-detail__section">
            <h2 className="assignment-detail__section-title">Инструкция:</h2>
          ...
          <div className="assignment-detail__section">
            <h2 className="assignment-detail__section-title">Создатель:</h2>
            <p className="assignment-detail__section-text">
              {assignment.creator
          ...
          <div className="assignment-detail__section">
            <h2 className="assignment-detail__section-title">Команда:</h2>
            <p className="assignment-detail__section-text">
          ...
          {assignment.Assignments_investments?.length > 0 && (
            <div className="assignment-detail__section">
              <h2 className="assignment-detail__section-title">Вложения:</h2>
        ...
        <div className="assignment-detail__submission">
          <div className="assignment-detail__submission-header">
            <h2 className="assignment-detail__submission-title">Моя работа</h2>
            {submissionExists ? (
          ...
          <SubmissionForm assignment_id={id} submission_id={submission_id} />
        </div>
      </div> 
    </div>
  );
